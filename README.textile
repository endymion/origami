...
Sensible CSS defaults from "Blueprint":http://www.blueprintcss.org/.

h3. AssetPackager

Uses "AssetPackager":http://synthesis.sbecker.net/pages/asset_packager to compress CSS and Javascript, and to ensure that only ONE style file and ONE Javascript file needs to be sent to the browser in production mode.
...
First make sure that you have "AssetPackager":http://synthesis.sbecker.net/pages/asset_packager
